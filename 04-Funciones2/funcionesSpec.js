...
describe('higher-order functions', function() {
  ...
  it('Puedo pasar una función como argumento', function() {
    ...
    // y retornar sus resultadopuestas concatenadas
    expect(invocarFunciones(funcionParaInvocar, otraFuncion)).toEqual('Me llamaron! y después a otra!');
  });
});

// Ahora repasemos los conceptos de `clousuresultado`.
...
// abajo, ¿porque usaríamos clousuresultado para esto? porque no esta permitido guardar
